...
<head>
    ...
    <title>HNIN AKARI NWE · Edit <?php echo htmlspecialchars($emp['name']); ?></title>
...
<body x-data="{}" class="bg-slate-50 dark:bg-[#0B1120] text-slate-900 dark:text-white font-sans antialiased min-h-screen flex">
    ...
    <div class="flex-1 flex flex-col min-w-0 main-wrapper">
        ...
        $page_actions = '<span class="inline-flex items-center gap-2 rounded-full bg-card-custom px-3 py-1 border border-body text-sm text-body-secondary"><i class="fa-solid fa-id-badge text-blue-400"></i> ' . htmlspecialchars($emp['employee_code']) . '</span>';
        include "../includes/topbar.php"; ?>
        <main class="flex-1 p-8 overflow-y-auto">
            <?php if ($message): ?>
                <div class="mb-6 rounded-2xl px-6 py-4 shadow-sm border <?php echo $message_type === 'success' ? 'bg-emerald-500/20 border-emerald-500/30 text-emerald-400' : 'bg-red-500/20  text-red-400'; ?>">
            ...
            <form action="edit_employee.php" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 xl:grid-cols-[1.6fr_1fr] gap-6 items-stretch">
                ...
                <div class="group glass-strong rounded-2xl hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
                    <div class="rounded-t-2xl border-b border-white/[0.06] bg-white/[0.04] px-6 py-4 text-white font-semibold shadow-sm">
                        <i class="fa-solid fa-user text-blue-400 mr-2"></i>Personal Details
                    </div>
                    <div class="p-6 space-y-5">
                        <div class="flex items-center gap-4">
                            <div class="relative">
                                ...
                                <label for="profile_photo" class="absolute bottom-0 right-0 w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center cursor-pointer shadow-md hover:bg-blue-400 transition">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="<?php echo htmlspecialchars($emp['name']); ?>" required class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                        </div>

                        <div>
                            <label class="block text-xs font-semibold text-zinc-400 mb-2">Father Name</label>
                            <input type="text" name="father_name" value="<?php echo htmlspecialchars($emp['father_name'] ?: ''); ?>" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                        </div>
                        <div class="grid gap-4 lg:grid-cols-2">
                            <div>
                                <label class="block text-xs font-semibold text-zinc-400 mb-2">Date Of Birth <span class="text-rose-500">*</span></label>
                                <input type="date" name="dob" value="<?php echo htmlspecialchars($emp['dob'] ?: ''); ?>" required class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-zinc-400 mb-2">Gender</label>
                                <select name="gender" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-12 gap-2" id="nrc-container">
                                ...
                                <div class="col-span-2">
                                    <input type="text" name="nrc_number" id="nrc_number" value="<?php echo htmlspecialchars($nrc_number_val); ?>" maxlength="6" placeholder="123456" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-2 py-3 text-sm text-white placeholder-zinc-500 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                                </div>
                            </div>
                            <div id="nrc-preview" class="mt-2 text-xs text-zinc-400 <?php echo $nrc_state_val ? '' : 'hidden'; ?>">
                                NRC: <span id="nrc-preview-value" class="text-blue-400 font-mono font-semibold"><?php echo htmlspecialchars($emp['nrc'] ?: ''); ?></span>
                            </div>
                        </div>
                        <div>
                            <label class="block text-xs font-semibold text-zinc-400 mb-2">Married Status</label>
                            <input type="text" name="married_status" value="<?php echo htmlspecialchars($emp['married_status'] ?: ''); ?>" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                        </div>
                        <div>
                            <label class="block text-xs font-semibold text-zinc-400 mb-2">Ethnicity</label>
                            <input type="text" name="ethnicity" value="<?php echo htmlspecialchars($emp['ethnicity'] ?: ''); ?>" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                        </div>
                        <div>
                            <label class="block text-xs font-semibold text-zinc-400 mb-2">Religion</label>
                            <select name="religion" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" value="<?php echo htmlspecialchars($emp['phone'] ?: ''); ?>" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                        </div>
                        <div>
                            <label class="block text-xs font-semibold text-zinc-400 mb-2">Permanent Address</label>
                            <textarea name="permanent_address" rows="3" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30"><?php echo htmlspecialchars($emp['permanent_address'] ?: ''); ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="group glass-strong rounded-2xl hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
                        <div class="rounded-t-2xl border-b border-white/[0.06] bg-white/[0.04] px-6 py-4 text-white font-semibold shadow-sm">
                            <i class="fa-solid fa-lock text-blue-400 mr-2"></i>Account Login
                        </div>
                        <div class="p-6 space-y-5">
                            <div>
                                <label class="block text-xs font-semibold text-zinc-400 mb-2">Email <span class="text-rose-500">*</span></label>
                                <input type="email" name="email" value="<?php echo htmlspecialchars($emp['email']); ?>" required class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                            </div>
                            <div>
                                ...
                                <div class="relative">
                                    <input type="password" name="password" id="edit-emp-pw" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 pr-11 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                                    <span class="pw-eye-toggle absolute right-3 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-blue-400 cursor-pointer select-none z-10" role="button" tabindex="0" data-target="edit-emp-pw">
                    ...
                    <div class="group glass-strong rounded-2xl hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
                        <div class="rounded-t-2xl border-b border-white/[0.06] bg-white/[0.04] px-6 py-4 text-white font-semibold shadow-sm">
                            <i class="fa-solid fa-building text-blue-400 mr-2"></i>Company Details
                        </div>
                        <div class="p-6 space-y-5">
                            <div>
                            ...
                            <div>
                                ...
                                <select name="department_id" required class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                            ...
                            <div>
                                ...
                                <select name="position_id" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                            ...
                            <div class="grid gap-4 lg:grid-cols-2">
                                <div>
                                    ...
                                    <input type="date" name="doj" value="<?php echo htmlspecialchars($emp['hire_date'] ?: ''); ?>" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                                </div>
                                <div>
                                    <label class="block text-xs font-semibold text-zinc-400 mb-2">Status</label>
                                    <select name="status" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                            ...
                            <div>
                                ...
                                <input type="text" name="designation" value="<?php echo htmlspecialchars($emp['role'] ?: ''); ?>" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group glass-strong rounded-2xl hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
                        <div class="rounded-t-2xl border-b border-white/[0.06] bg-white/[0.04] px-6 py-4 text-white font-semibold shadow-sm">
                            <i class="fa-solid fa-coins text-blue-400 mr-2"></i>Financial Details
                        </div>
                        <div class="p-6 space-y-5">
                            <div>
                                <label class="block text-xs font-semibold text-zinc-400 mb-2">Basic Salary</label>
                                <input type="number" name="basic_salary" value="<?php echo htmlspecialchars($emp['basic_salary'] ?: '0'); ?>" step="0.01" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-zinc-400 mb-2">Allowance</label>
                                <input type="number" name="allowance" value="<?php echo htmlspecialchars($emp['allowance'] ?: '0'); ?>" step="0.01" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                            </div>
                            <div class="flex gap-3">
                                <button type="submit" class="flex-1 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold text-sm px-5 py-3 shadow-sm transition flex items-center justify-center gap-2">
