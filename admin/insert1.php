                ...
                <div class="group glass-strong rounded-2xl hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="emp_name" value="<?php echo isset($_POST['name']) ? htmlspecialchars($_POST['name']) : ''; ?>" required class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30" placeholder="Enter employee name">
                        </div>

                        <div>
                            <label class="block text-xs font-semibold text-zinc-400 mb-1.5">Father Name</label>
                            <input type="text" name="father_name" id="father_name" value="<?php echo isset($_POST['father_name']) ? htmlspecialchars($_POST['father_name']) : ''; ?>" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30" placeholder="Enter father name">
                        </div>
                        <div class="grid gap-4 lg:grid-cols-2">
                            <div>
                                <label class="block text-xs font-semibold text-zinc-400 mb-1.5">Date Of Birth <span class="text-rose-500">*</span></label>
                                <input type="date" name="dob" value="<?php echo isset($_POST['dob']) ? htmlspecialchars($_POST['dob']) : ''; ?>" required class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <div id="nrc-preview" class="mt-2 text-xs text-zinc-400 <?php echo isset($_POST['nrc_state']) ? '' : 'hidden'; ?>">
                                NRC: <span id="nrc-preview-value" class="text-blue-400 font-mono font-semibold"><?php echo isset($_POST['nrc_state']) ? htmlspecialchars($nrc) : ''; ?></span>
                            </div>
                        </div>
                        <div class="grid gap-4 lg:grid-cols-2">
                            <div>
                                <label class="block text-xs font-semibold text-zinc-400 mb-1.5">Married Status</label>
                                <select name="married_status" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                            ...
                            <div>
                                ...
                                <input type="text" name="ethnicity" id="ethnicity" value="<?php echo isset($_POST['ethnicity']) ? htmlspecialchars($_POST['ethnicity']) : ''; ?>" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30" placeholder="Enter ethnicity">
                            </div>
                        </div>
                        <div>
                        ...
                        <div class="grid gap-4 lg:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="phone" id="phone" value="<?php echo isset($_POST['phone']) ? htmlspecialchars($_POST['phone']) : ''; ?>" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30" placeholder="Enter phone number">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-zinc-400 mb-1.5">Allowance</label>
                                <input type="number" name="allwance" id="allowance" value="<?php echo isset($_POST['allwance']) ? htmlspecialchars($_POST['allwance']) : ''; ?>" step="0.01" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30" placeholder="0.00">
                            </div>
                        </div>
                        <div>
                            <label class="block text-xs font-semibold text-zinc-400 mb-1.5">Permanent Address</label>
                            <textarea name="permanent_address" id="permanent_address" rows="3" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30" placeholder="Enter permanent address"><?php echo isset($_POST['permanent_address']) ? htmlspecialchars($_POST['permanent_address']) : ''; ?></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="group glass-strong rounded-2xl hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
                        ...
                        <div class="p-6 space-y-5">
                            <div>
                                ...
                                <input type="email" name="email" id="emp_email" value="<?php echo isset($_POST['email']) ? htmlspecialchars($_POST['email']) : ''; ?>" required class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30" placeholder="Enter email address">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-zinc-400 mb-1.5">Password <span class="text-rose-500">*</span></label>
                                <div class="relative">
                                    <input type="password" name="password" id="emp_password" required class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 pr-11 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30" placeholder="Enter password">
                                    <span class="pw-eye-toggle absolute right-3 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-blue-400 cursor-pointer select-none z-10" role="button" tabindex="0" data-target="emp_password">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="password" name="confirm_password" id="confirm_password" required class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 pr-11 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30" placeholder="Confirm password">
                                    <span class="pw-eye-toggle absolute right-3 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-blue-400 cursor-pointer select-none z-10" role="button" tabindex="0" data-target="confirm_password">
                                        <i class="fa-solid fa-eye text-base"></i>
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="group glass-strong rounded-2xl hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <select name="department_id" id="department" required class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                            ...
                            <div>
                                ...
                                <select name="position_id" id="designation" required class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                            ...
                            <div class="grid gap-4 lg:grid-cols-2">
                                <div>
                                    ...
                                    <input type="date" name="doj" value="<?php echo isset($_POST['doj']) ? htmlspecialchars($_POST['doj']) : ''; ?>" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30">
                                </div>
                                <div>
                    ...
                    <div class="group glass-strong rounded-2xl hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
                        ...
                        <div class="p-6 space-y-5">
                            <div>
                                ...
                                <input type="number" name="basic_salary" id="basic_salary" value="<?php echo isset($_POST['basic_salary']) ? htmlspecialchars($_POST['basic_salary']) : ''; ?>" step="0.01" class="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white placeholder-zinc-500 shadow-sm outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30" placeholder="0.00">
                            </div>
                            <div class="pt-2">
                                <button type="submit" class="w-full rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold text-sm px-5 py-3.5 shadow-lg shadow-blue-600/20 transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center gap-2">
