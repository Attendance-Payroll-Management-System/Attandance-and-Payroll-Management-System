...
<body class="min-h-screen flex flex-col items-center justify-center bg-grid px-4 bg-body text-body overflow-hidden">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <svg class="absolute bottom-1/4 right-1/4 w-20 h-20 text-indigo-500/5 animate-float" viewBox="0 0 24 24" fill="currentColor"><path d="M21 16v-2l-8-5V3.5c0-.83-.67-1.5-1.5-1.5S10 2.67 10 3.5V9l-8 5v2l8-2.5V19l-2 1.5V22l3.5-1 3.5 1v-1.5L13 19v-5.5l8 2.5z"/></svg>
    </div>
        ...
        <div class="border-gradient text-body w-full flex flex-col p-8 gap-6 rounded-2xl animate-fade-in-up stagger-1">
            ...
            <?php echo csrf_field(); ?>
                ...
                <div class="space-y-1.5">
                    <label class="text-sm font-medium text-zinc-300"><i class="fa-solid fa-lock mr-1.5 text-sky-400"></i>New Password</label>
                    <div class="relative">
                        <input type="password" name="password" id="reset-new-pw" placeholder="Min. 6 characters" required minlength="6" class="w-full px-4 py-3 pr-11 rounded-xl bg-white/[0.06] border border-white/10 text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-sky-500/50 transition-all">
                        <span class="pw-eye-toggle absolute right-3 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-sky-400 cursor-pointer select-none z-10" role="button" tabindex="0" data-target="reset-new-pw">
                            <i class="fa-solid fa-eye text-base"></i>
                        </span>
                    </div>
                </div>
                <div class="space-y-1.5">
                    <label class="text-sm font-medium text-zinc-300"><i class="fa-solid fa-check-circle mr-1.5 text-sky-400"></i>Confirm Password</label>
                    <div class="relative">
                        <input type="password" name="confirm_password" id="reset-confirm-pw" placeholder="Repeat new password" required class="w-full px-4 py-3 pr-11 rounded-xl bg-white/[0.06] border border-white/10 text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-sky-500/50 transition-all">
                        <span class="pw-eye-toggle absolute right-3 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-sky-400 cursor-pointer select-none z-10" role="button" tabindex="0" data-target="reset-confirm-pw">
                            <i class="fa-solid fa-eye text-base"></i>
                        </span>
                    </div>
                </div>
            ...
            <div class="text-center">
                <a href="login.php" class="text-sky-400 hover:text-sky-300 font-semibold text-sm transition-colors"><i class="fa-solid fa-arrow-left mr-1"></i> Back to Login</a>
            </div>
            </div>
        </div>
